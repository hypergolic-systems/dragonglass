...
namespace Dragonglass.Hud
{
    internal static class Layout
    {
        ...
        /// name; bump on any layout change.
        /// </summary>
        ...
        // Punch-through stream rects do NOT live in SHM. They ride
        // inside the CEF render output (a hidden 1-px-tall encoding row
        // at the top of the page) and are decoded by the Unity-side
        // plugin from the IOSurface itself — same buffer as the visible
        // HUD pixels, atomically delivered, no IPC race possible.
    }
}
